...
<div className="min-h-auto min-w-48 max-w-10 overflow-hidden  text-center">
             <img src="vtopmockup.png" alt="orchid" className="hover:scale-125 h-[22rem] object-cover ease-in duration-150"/>
            </div>
  <div className="p-4 flex flex-col justify-between leading-normal">
    <div className="mb-4">
          <div className="text-2xl z-10 font-mono font-bold">01</div>
           <div className="text-5xl z-10 font-mono font-bold pb-5">VTOP - VIT Bhopal</div>
           <p className="z-10 font-mono opacity-75">VTOP: Where VIT Bhopal students connect and thrive, simplifying campus life. Available on Google Play Store!</p>
</div>
...
<span className="bg-yellow-100 text-yellow-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-yellow-300 border border-yellow-300">Android</span>
...
<div className=" flex gap-2 w-1/2 items-center">
           <a href='https://play.google.com/store/apps/details?id=com.shreyxnsh.vtop&hl=en&gl=US' target="_blank"><button className="cursor-pointer mt-5 px-3 py-1 hover:bg-transparent hover:animate-pulse border-2 w-full bg-white text-black font-bold hover:text-white">Google Play Store</button></a>
        
           <a href='https://github.com/shreyxnsh/VTOP/' target="_blank">
...
<div className="min-h-auto min-w-48 max-w-10 w-100 overflow-hidden border text-center">
     <img src="vitkart-logo.png" alt="orchid" style={{objectFit: "cover"}} className="hover:scale-125 object-cover  h-[21rem] ease-in duration-150"/>
  </div>
</div>
  ...
  <div className="p-4 flex flex-col justify-between leading-normal">
    <div className="mb-2">
          <div className="text-2xl z-10 font-mono font-bold">02</div>
           <div className="text-5xl z-10 font-mono font-bold pb-5">VITKART</div>
           <p className="z-10 font-mono opacity-75">An ecommerce application built for the students of VIT Bhopal. VITKART gives an option to the students to buy and sell necessary products like books, buckets, mattresses, cycles, technology products and many more.</p>
</div>
<div className='flex gap-2 flex-wrap mb-3'>
  <span className="bg-blue-100 text-blue-800 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-blue-400 border border-blue-400">
  <svg className="w-2.5 h-2.5 mr-1.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
...
<span className="bg-yellow-100 text-yellow-800 text-xs font-medium mr-2 px-2.5 py-0.5 rounded dark:bg-gray-700 dark:text-yellow-300 border border-yellow-300">Full-Stack App</span>
...
<div className=" flex gap-2 w-1/2 items-center">
           ...
           <a href='https://github.com/shreyxnsh/vitkart' target="_blank"><button className="cursor-pointer mt-5 px-3 py-1 hover:bg-cyan-400 hover:animate-pulse border-2 w-full">Github</button></a>
